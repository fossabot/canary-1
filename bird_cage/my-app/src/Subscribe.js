  ...
  return (
    <Col>
        <Form onSubmit={props.onClick}>
            ...
            <Col sm={6}>
            <Button color="danger" align='left' id='Subscribe'>Subscribe</Button>
            </Col>
        </Form>
    </Col>
  );
  ...
  return (
    <Col>
        <Form onSubmit={props.onClick}>
            ...
            <Col sm={6}>
            <Button color="secondary" align='right' id='Unsubscribe'>Unsubscribe</Button>
            </Col>
        </Form>
    </Col>
  );
  ...
  return (
    <Col>
        <Form onSubmit={props.onClick}>
            ...
            <Col sm={6}>
            <Button color="secondary" align='right' id='ConfirmUnsubscribe'>Confirm Unsubscription</Button>
            </Col>
        </Form>
    </Col>
  );
  ...
  return (
    <Col>
        <Form onSubmit={props.onClick}>
            ...
            <Col sm={6}>
            <Button color="danger" align='right' id='ConfirmSubscribe'>Confirm Subscription</Button>
            </Col>
        </Form>
    </Col>
  );
